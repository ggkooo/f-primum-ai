...
export function ComposerActions({ isListening, isSpeechSupported, onToggleSpeech, onSend }: ComposerActionsProps) {
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        onClick={onSend}
        className="ml-1 grid h-10 w-10 place-items-center rounded-full bg-[#006b1f] text-white transition hover:bg-[#005d1a]"
      >
